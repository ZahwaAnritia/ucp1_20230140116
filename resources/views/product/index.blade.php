<x-app-layout>
    ...
    {{-- Tombol View: Ubah link-nya ke product.show --}}
    ...
    {{-- Tombol Edit: Hanya muncul jika user adalah pemilik (Policy Update) --}}
    @can('update', $product)
    ...
    @endcan
                                            {{-- Tombol Delete: Muncul jika pemilik atau admin (Policy Delete) --}}
    @can('delete', $product)
                                ...
                                <td colspan="6" 
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" 
                                        ...
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" 
                                            d="M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0v7m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5m16 0h2.586a1 1 0 00-.707.293l-2.414 2.414a1 1 0 01-.707.293h-3.172a1 1 0 01-.707-.2931-2.414-2.414A1 1 0 006.586 13H4" />
                                    </svg>
                                    No products found.
                                </td>
                            </tr>
