            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="flex items-center gap-3 mb-6">
                    <a href="{{route('product.index')}}"
                        class="p-1.5 rounded-md text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 transaction">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="number" name="qty" id="qty" value="{{old('qty')}}"
                                placeholder="0" min="0"
                                class="w-full px-4py-2.5 rounded-lg border text-sm
                        ...
                        <div class="flex items-center justify-end gap-3 pt-2">
                            ...
                            <button type="submit" 
                                class="px-4 py-2 rounded-lg bg-indigo-600 text-sm text-white hover:bg-indigo-700 transition">
                                Save Product
                            </button>
                        </div>
                </form>
