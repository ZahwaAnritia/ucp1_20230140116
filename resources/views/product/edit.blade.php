            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form action="{{ route('product.update', $product) }}"
                        ...
                        <select name="category_id" class="w-full bg-[#111827] border-gray-600 rounded-lg py-2.5 px-4 text-white focus:ring-2 focus:ring-indigo-500 outline-none transition">
                        ...
                        <div class="flex items-center justify-between pt-2">
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <button type="submit"
                                    class="px-4 py-2.5 rounded-lg bg-indigo-600 text-sm font-medium text-white hover:bg-indigo-700 transition">
                                    Update Product
                                </button>
                            </div>
                        </div>
